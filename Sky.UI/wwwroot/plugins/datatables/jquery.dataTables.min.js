...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Sonraki",sPrevious:"Önceki"},sEmptyTable:"Gösterilecek veri bulunamadı",sInfo:" _TOTAL_ kayıttan _START_ ile _END_ arası gösteriliyor",sInfoEmpty:"_TOTAL_ kayıttan _END_ ile _END_ arası gösteriliyor",
